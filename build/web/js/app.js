...
(function(/*! Stitch !*/) {
...
}, "collections/pomodoros_collection": function(exports, require, module) {(function() {
  var Pomodoro;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  Pomodoro = require('models/pomodoro_model').Pomodoro;

  exports.Pomodoros = (function() {

    __extends(Pomodoros, Backbone.Collection);
...
}, "collections/states_collection": function(exports, require, module) {(function() {
  var State;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  exports.States = (function() {
    ...
    __extends(States, Backbone.Collection);
  ...
  $(document).ready(function() {
    app.initialize = function() {
      ...
      if (Backbone.history.getFragment() === '') {
        return app.routers.main.navigate(currentStateName, true);
      }
    };
    app.initialize();
...
}, "models/pomodoro_model": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  exports.Pomodoro = (function() {

    __extends(Pomodoro, Backbone.Model);
...
}, "models/state_model": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/timer": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
...
}, "views/resting_view": function(exports, require, module) {(function() {
  var timerTemplate;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  timerTemplate = require('templates/timer');

  exports.RestingView = (function() {

    __extends(RestingView, Backbone.View);
  ...
  exports.StatsView = (function() {
    ...
    StatsView.prototype.render = function() {
      this.$(this.el).html(statsTemplate({
        title: "stats",
        count: app.collections.pomodoros.length
      }));
      this.$(this.el).modal({
        backdrop: 'static',
        show: true
...
}, "views/working_view": function(exports, require, module) {(function() {
  var timerTemplate;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  timerTemplate = require('templates/timer');

  exports.WorkingView = (function() {

    __extends(WorkingView, Backbone.View);
